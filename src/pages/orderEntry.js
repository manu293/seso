    ...
    <div className="mainContainer">
        ...
        <div className="orderEntryHeader">
          <div className="orderEntryHeaderLeftSection">
            <p className="orderEntryHeaderSubText">
              Orders &nbsp; <CaretRight size={30} weight="bold" /> &nbsp; Order
              Entry
            </p>
              ...
              <tr className="orderEntryTableRow">
                ...
                <td className="orderEntryTableText">
                  <div className="orderStatusContainer">
                    ...
                    <p className="orderStatusText"> 1000 / 200</p>&nbsp;&nbsp;
                    <p className="orderStatusSubText">in kg</p>
                  </div>
                </td>
                <td className="orderEntryTableText">
                ...
                <td className="orderEntryTableText">
                  <DotsThreeVertical size={23} weight="bold" color="#F78D12" />
                </td>
              </tr>
      ...
      {showAddOrder === true && (
        <NewOrder
          ...
          passedDownRef={orderEntryCreateRef}
        />
      )}
    </div>
  );
