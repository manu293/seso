...
import {stringToBase64} from "../helpers/utils";
import {fetchAdminCustomers, addAdminCustomer} from "../actions";
        ...
        return (
            <div className="entryFilterContainer">
                <div className="addAdminContainer" ref={adminCustomerPopUpRef}>
                    ...
                    <form className="addAdminUserForm" onSubmit={(e) => handleAddNewCustomer(e)}>
                        <div className="addAdminUserBodyContainer">
                                ...
                                <div className="avatar-preview">
                                    {
                                        ...
                                        :
                                            <div id="imagePreview" style={{backgroundImage: `url(${newCustomer.imageurl})`}} />
                                    }
                            ...
                            <div className="accountReportTextField addAdminUserMargin">
                                <input
                                    ...
                                    onChange={(e) => handleNewUserEntry(e)}
                                />
                                <label className="orderInputLabel">Customer NickName</label>
                            </div>
                        ...
                        <div className="addAdminUserButtonContainer">
                            ...
                            <button
                                className="addAdminUserSaveButton"
                                type="submit"
                ...
                return (
                    <tr className="adminUserTableBodyRow" key={`customer-${customer.id}`}>
                        <th className="adminUserTableBodyCustomerName">
                            ...
                            <p className="adminUserTableBodyCustomerNameText">{customer.customername}</p>
                        </th>
...
export default connect(mapStateToProps, {fetchAdminCustomers, addAdminCustomer})(AdminCustomer);