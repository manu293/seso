...
import YarnReturnPopUp from "../components/yarnReturnPopUp";

// styles
import "../styles/orderReport.css";

const OrderYarnReturn = () => {
            ...
            <div className="mainContentContainer">
                ...
                <div className="orderEntryHeader">
                    ...
                    <div className="orderEntryHeaderLeftSection">
                        <p className="orderEntryHeaderSubText">Orders &nbsp; <CaretRight size={30} weight="bold" /> &nbsp; Yarn Return</p>
                    ...
                    <table className="orderEntryTable">
                        <thead>
                            <tr className="orderEntryTableHeader">
                                ...
                                <th className="orderEntryTableHeaderText">YR No</th>
...
export default OrderYarnReturn;